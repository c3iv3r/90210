...
do
	...
	function background(pl, t, d, i, ty)
		...
		TextLabel_1.BackgroundColor3 = CurrentTheme.TextPrimary
		...
		TextLabel_2.BackgroundColor3 = CurrentTheme.TextPrimary
...
local Notification = Instance.new("Frame")
	...
	if not Notification then
		...
		Description_1.TextColor3 = CurrentTheme.TextPrimary
...
function Library:Window(p)
	...
	Desc_1.Text = Desc
	Desc_1.TextColor3 = CurrentTheme.TextPrimary
	Desc_1.TextSize = 10
	...
	ScrollingFrame_2.BackgroundColor3 = CurrentTheme.WindowBorder
	...
	function Tabs:Tab(p)
		...
		Title_3.Name = "Title"
		Title_3.Parent = Func
		Title_3.BackgroundColor3 = CurrentTheme.TextPrimary
    ...
    twSelect()
        ...
        function Func:Label(p)
			...
			local Label, Config = background(ScrollingFrame_1, Title, Desc, Image)
        ...
        function Func:Button(p)
			...
			local Button, Config = background(ScrollingFrame_1, Title, Desc, Image)
        ...
        function Func:Slider(idx, p)
		 ...
		 idx = nil
			...
			FrameValueTextBox.BackgroundColor3 = CurrentTheme.ElementBackground
			...
			Frame_2.BackgroundColor3 = CurrentTheme.ElementStroke
			Frame_2.BorderColor3 = Color3.fromRGB(0,0,0)
			Frame_2.BorderSizePixel = 0
        ...
        function Func:Dropdown(idx, p)
			...
			local Dropdown, Config = background(ScrollingFrame_1, Title, Desc, Image)
        ...
        function Func:Textbox(idx, p)
			...
			Frame_1.BorderColor3 = CurrentTheme.WindowBackground
			Frame_1.BorderSizePixel = 0
