...
function Library:Window(p)
 ...
 function Func:Dropdown(idx, p)
    ...
    local UIListLayout_Header = Instance.new("UIListLayout")
    ...
    if Icon then
        ...
        if GetLucideIcon then
            ...
            if iconData then
                IconImage.Image = iconData.Image or iconData[1]
                IconImage.ImageRectOffset = iconData.ImageRectOffset or iconData[2]
                IconImage.ImageRectSize = iconData.ImageRectSize or iconData[3]
            end
        end
    ...
    function New:SetIcon(iconName)
        if not GetLucideIcon then
            warn("Lucide icon loader not available")
            return
        end
    ...
    function New:GetState()
        return {
            IsOpen = isOpen,
            Title = Section_1.Text,
            Icon = currentIcon
        }
    end
